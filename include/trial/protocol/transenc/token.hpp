#ifndef TRIAL_PROTOCOL_TRANSENC_TOKEN_HPP
#define TRIAL_PROTOCOL_TRANSENC_TOKEN_HPP
...
#include <trial/protocol/transenc/detail/token.ipp>

#endif // TRIAL_PROTOCOL_TRANSENC_TOKEN_HPP

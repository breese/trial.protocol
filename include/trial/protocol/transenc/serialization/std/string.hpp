#ifndef TRIAL_PROTOCOL_TRANSENC_SERIALIZATION_STD_STRING_HPP
#define TRIAL_PROTOCOL_TRANSENC_SERIALIZATION_STD_STRING_HPP
...
#endif // TRIAL_PROTOCOL_TRANSENC_SERIALIZATION_STD_STRING_HPP

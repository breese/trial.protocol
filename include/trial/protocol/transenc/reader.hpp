#ifndef TRIAL_PROTOCOL_TRANSENC_READER_HPP
#define TRIAL_PROTOCOL_TRANSENC_READER_HPP
...
#include <trial/protocol/transenc/detail/reader.ipp>

#endif // TRIAL_PROTOCOL_TRANSENC_READER_HPP

#ifndef TRIAL_PROTOCOL_TRANSENC_DETAIL_DECODER_IPP
#define TRIAL_PROTOCOL_TRANSENC_DETAIL_DECODER_IPP
...
{
    return transenc::make_error_code(to_errc(code()));
}
...
#endif // TRIAL_PROTOCOL_TRANSENC_DETAIL_DECODER_IPP

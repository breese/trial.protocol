...
BOOST_AUTO_TEST_CASE(test_empty)
{
    ...
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::end);
}
...
BOOST_AUTO_TEST_CASE(test_junk)
{
    ...
    json::detail::decoder decoder(input);
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::error_unexpected_token);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::error_unexpected_token);
}
...
BOOST_AUTO_TEST_CASE(test_null)
{
    ...
    json::detail::decoder decoder(input);
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::null);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::end);
}
...
BOOST_AUTO_TEST_CASE(test_false)
{
    ...
    json::detail::decoder decoder(input);
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::false_value);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::end);
}
...
BOOST_AUTO_TEST_CASE(test_true)
{
    ...
    json::detail::decoder decoder(input);
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::true_value);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::end);
}
...
BOOST_AUTO_TEST_CASE(test_integer_zero)
{
    const char input[] = "0";
    json::detail::decoder decoder(input);
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::integer);
...
BOOST_AUTO_TEST_CASE(test_floating_zero)
{
    ...
    json::detail::decoder decoder(input);
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::floating);
...
BOOST_AUTO_TEST_CASE(test_string_empty)
{
    const char input[] = "\"\"";
    json::detail::decoder decoder(input);
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::string);
...
BOOST_AUTO_TEST_CASE(test_begin_object)
{
    const char input[] = "{";
    json::detail::decoder decoder(input);
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::begin_object);
    BOOST_REQUIRE_EQUAL(decoder.literal(), "{");
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::end);
}
...
BOOST_AUTO_TEST_CASE(test_end_object)
{
    const char input[] = "}";
    json::detail::decoder decoder(input);
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::end_object);
    BOOST_REQUIRE_EQUAL(decoder.literal(), "}");
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::end);
}
...
BOOST_AUTO_TEST_CASE(test_object)
{
    ...
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::name_separator);
    BOOST_REQUIRE_EQUAL(decoder.literal(), ":");
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::false_value);
    decoder.next();
...
BOOST_AUTO_TEST_CASE(test_array_begin)
{
    const char input[] = "[";
    json::detail::decoder decoder(input);
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::begin_array);
    BOOST_REQUIRE_EQUAL(decoder.literal(), "[");
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::end);
}
...
BOOST_AUTO_TEST_CASE(test_array_end)
{
    const char input[] = "]";
    json::detail::decoder decoder(input);
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::end_array);
    BOOST_REQUIRE_EQUAL(decoder.literal(), "]");
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::end);
}
...
BOOST_AUTO_TEST_CASE(test_array)
{
    ...
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::true_value);
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::value_separator);
    BOOST_REQUIRE_EQUAL(decoder.literal(), ",");
    decoder.next();
    BOOST_REQUIRE_EQUAL(decoder.code(), json::code::false_value);
    decoder.next();

...
BOOST_AUTO_TEST_CASE(test_integer)
{
    const char input[] = "1";
    json::reader reader(input);
    BOOST_REQUIRE_EQUAL(reader.code(), token::code::integer);
...
BOOST_AUTO_TEST_CASE(test_float)
{
    ...
    json::reader reader(input);
    BOOST_REQUIRE_EQUAL(reader.code(), token::code::floating);
...
BOOST_AUTO_TEST_CASE(test_string)
{
    ...
    json::reader reader(input);
    BOOST_REQUIRE_EQUAL(reader.code(), token::code::string);
...
BOOST_AUTO_TEST_CASE(test_array_empty)
{
    const char input[] = "[]";
    json::reader reader(input);
    BOOST_REQUIRE_EQUAL(reader.code(), token::code::begin_array);
    BOOST_REQUIRE_EQUAL(reader.symbol(), token::symbol::begin_array);
    ...
    BOOST_REQUIRE_EQUAL(reader.code(), token::code::end_array);
    BOOST_REQUIRE_EQUAL(reader.symbol(), token::symbol::end_array);
    BOOST_REQUIRE_EQUAL(reader.category(), token::category::structural);
...
BOOST_AUTO_TEST_CASE(test_object_empty)
{
    const char input[] = "{}";
    json::reader reader(input);
    BOOST_REQUIRE_EQUAL(reader.code(), token::code::begin_object);
    BOOST_REQUIRE_EQUAL(reader.symbol(), token::symbol::begin_object);
    BOOST_REQUIRE_EQUAL(reader.category(), token::category::structural);
    BOOST_REQUIRE_EQUAL(reader.level(), 0);
    BOOST_REQUIRE_EQUAL(reader.next(), true);
    BOOST_REQUIRE_EQUAL(reader.code(), token::code::end_object);
    BOOST_REQUIRE_EQUAL(reader.symbol(), token::symbol::end_object);
    BOOST_REQUIRE_EQUAL(reader.category(), token::category::structural);
    BOOST_REQUIRE_EQUAL(reader.level(), 1);
    BOOST_REQUIRE_EQUAL(reader.next(), false);
    BOOST_REQUIRE_EQUAL(reader.code(), token::code::end);
...
BOOST_AUTO_TEST_CASE(fail_object_missing_colon)
{
    ...
    BOOST_REQUIRE_EQUAL(reader.level(), 1);
    BOOST_REQUIRE_EQUAL(reader.next(), false);
    BOOST_REQUIRE_EQUAL(reader.code(), token::code::error_unexpected_token);
    BOOST_REQUIRE_EQUAL(reader.error(), json::unexpected_token);
}
...
BOOST_AUTO_TEST_CASE(fail_object_invalid_integer_key)
{
    ...
    BOOST_REQUIRE_EQUAL(reader.level(), 0);
    BOOST_REQUIRE_EQUAL(reader.next(), false);
    BOOST_REQUIRE_EQUAL(reader.code(), token::code::error_invalid_key);
...
BOOST_AUTO_TEST_CASE(fail_object_empty_mismatched)
{
    ...
    BOOST_REQUIRE_EQUAL(reader.level(), 0);
    BOOST_REQUIRE_EQUAL(reader.next(), false);
    BOOST_REQUIRE_EQUAL(reader.code(), token::code::error_expected_end_object);

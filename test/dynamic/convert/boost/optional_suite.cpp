...
#include <trial/dynamic/convert/boost/optional.hpp>
...
{
    variable data;
    auto result = convert::into<boost::optional<int>>(data);
...
{
    {
        ...
        variable data = value;
        auto result = convert::into<boost::optional<integer_type>>(data);
        TRIAL_PROTOCOL_TEST(result);
...
void convert_real()
{
    ...
    {
        variable data = 3.0f;
        auto result = convert::into<boost::optional<float>>(data);
        TRIAL_PROTOCOL_TEST(result);
    ...
    {
        variable data = 3.0f;
        auto result = convert::into<boost::optional<double>>(data);
        TRIAL_PROTOCOL_TEST(result);
    ...
    {
        variable data = 3.0f;
        auto result = convert::into<boost::optional<long double>>(data);
        TRIAL_PROTOCOL_TEST(result);
...
void convert_string()
{
    {
        variable data = "alpha";
        auto result = convert::into<boost::optional<std::string>>(data);
        TRIAL_PROTOCOL_TEST(result);
        TRIAL_PROTOCOL_TEST(result == std::string("alpha"));
    }
    {
        variable data = L"bravo";
        auto result = convert::into<boost::optional<std::wstring>>(data);
        TRIAL_PROTOCOL_TEST(result);
        TRIAL_PROTOCOL_TEST(result == std::wstring(L"bravo"));
    }
    {
        variable data = u"charlie";
        auto result = convert::into<boost::optional<std::u16string>>(data);
        TRIAL_PROTOCOL_TEST(result);
        TRIAL_PROTOCOL_TEST(result == std::u16string(u"charlie"));
    }
    {
        variable data = U"delta";
        auto result = convert::into<boost::optional<std::u32string>>(data);
        TRIAL_PROTOCOL_TEST(result);
...
void fail_boolean()
{
    {
        variable data = true;
        TRIAL_PROTOCOL_TEST_THROW_EQUAL(convert::into<boost::optional<int>>(data),
                                        error,
                                        "incompatible type");
    }
    {
        variable data = true;
        TRIAL_PROTOCOL_TEST_THROW_EQUAL(convert::into<boost::optional<float>>(data),
                                        error,
                                        "incompatible type");
    }
    {
        variable data = true;
        TRIAL_PROTOCOL_TEST_THROW_EQUAL(convert::into<boost::optional<std::string>>(data),
                                        error,
                                        "incompatible type");
    }
}

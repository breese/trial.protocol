...
void test_zero()
{
    ...
    TRIAL_PROTOCOL_TEST_EQUAL(buffer.size(), 9);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[0], token::code::float64);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[1], 0x00);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[2], 0x00);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[3], 0x00);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[4], 0x00);
...
void test_one()
{
    ...
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[5], 0x00);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[6], 0x00);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[7], 0xF0);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[8], 0x3F);
}
...
void test_minus_one()
{
    ...
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[6], 0x00);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[7], 0xF0);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[8], 0xBF);
}
...
void test_two()
{
    ...
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[6], 0x00);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[7], 0x00);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[8], 0x40);
}
...
void test_minus_two()
{
    ...
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[6], 0x00);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[7], 0x00);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[8], 0xC0);
}
...
void test_binary8_empty()
{
    std::vector<value_type> buffer;
    format::detail::encoder encoder(buffer);
    std::vector<value_type> data;
    TRIAL_PROTOCOL_TEST_EQUAL(encoder.binary(data.data(), data.size()), 2);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer.size(), 2);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[0], token::code::binary8);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[1], 0x00);
}

void test_binary8_one()
{
    std::vector<value_type> buffer;
    format::detail::encoder encoder(buffer);
    std::vector<value_type> data;
    data.push_back(0x12);
    TRIAL_PROTOCOL_TEST_EQUAL(encoder.binary(data.data(), data.size()), 3);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer.size(), 3);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[0], token::code::binary8);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[1], 0x01);
    TRIAL_PROTOCOL_TEST_EQUAL(buffer[2], 0x12);
}
